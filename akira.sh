...
main() {
    ...
    screen -dmS AkiraUBot bash -c '
        ...
        pip3 install telethon googletrans pydub moviepy SpeechRecognition youtube_dl aiohttp beautifulsoup4 psutil GitPython Pillow emoji python-dotenv speedtest-cli
